   ...
   public void run()
   {
     ...
     /* for (Vertex v : graph)  {
      ...
      //String input = sc.nextLine();
		depthFirstTraversal(graph, Lab13Shell.commandLine);
		//sc.close();

   }
   public void depthFirstTraversal(Vector<Vertex> graph, String input) {
		...
		System.out.println("For starting vertex " + input + ", the depth-first traversal produces:");
